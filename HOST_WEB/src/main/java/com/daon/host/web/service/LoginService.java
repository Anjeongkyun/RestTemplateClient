...
//		
//		//validation check
//    	Set<ConstraintViolation<LoginVo.Login>> valiUser = validator.validate(login);
//        if (!valiUser.isEmpty()) {
//            StringBuilder sb = new StringBuilder();
//            for (ConstraintViolation<LoginVo.Login> constraintViolation : valiUser) {
...
//        }
		...
		return response.success(loginVo2, "조회 성공했습니다.", HttpStatus.OK);
	}
