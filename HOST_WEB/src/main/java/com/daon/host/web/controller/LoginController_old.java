...
//	
	...
	// 출입증 조회
	@GetMapping("/pass")
	public ResponseEntity<?> selectPass1() {
		return loginService.selectNo3();
	}

	// 출입증 조회
	@GetMapping("/pass/{aptId}")
	public ResponseEntity<?> selectPass() {
		return loginService.selectNo3();
	}

	// 출입증 등록
	@PostMapping("/pass1")
	public ResponseEntity<?> insertPass() {
		return loginService.selectNo3();
	}
	...
	@GetMapping()
	public ResponseEntity<?> selectNo3(@Validated Notice notice, @PathVariable String noticeNo, Errors errors) {
		// validation check
		if (errors.hasErrors()) {
