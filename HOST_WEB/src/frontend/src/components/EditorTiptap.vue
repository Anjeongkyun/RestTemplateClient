  ...
  <div class="editor">
    ...
    >
      <div class="menubar">
        ...
        <v-dialog v-model="imageDialog" max-width="540">
          ...
          <v-card class="pa-1">
            <v-tabs v-model="imageTab" grow text>
            ...
            <v-tabs-items v-model="imageTab">
              <v-tab-item key="1" value="imageTab-link">
                ...
                <v-card-actions>
                  <v-spacer></v-spacer>
                  <v-btn dark @click="insertImage(commands.image)">
                    Insert image
                  </v-btn>
                </v-card-actions>
              </v-tab-item>

              <v-tab-item key="2" value="imageTab-upload">
                <v-card-text class="mt-5">
                  <v-file-input
...
export default {
  ...
  computed: {
    DetailContents() {
      return this.$store.state.noticeStore.detailContents.noticeContent;
    }
  },
  watch: {
    contents() {
      this.editor.setContent(this.DetailContents);
    }
  },
  data() {
    return {
